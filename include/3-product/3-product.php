                    ...
                    <div class="card card-product">
                        ...
                        <div class="card-content">
                            ...
                            <div class="footer">
                                ...
                                <div class="stats">
                                    <button type="button" rel="tooltip" title="Сохранено" class="btn btn-just-icon btn-simple btn-rose">
                                        <i class="material-icons">favorite</i>
                                    </button>
                                </div>
                            </div>
...
<footer class="footer">
    <div class="container">
        ...
        <div class="copyright pull-right">
            ...
            </script>, made with <i class="fa fa-heart heart"></i> by <a href="#" target="_blank">Deryglazov</a>
        </div>
    </div>
</footer>